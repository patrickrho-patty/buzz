...
- The following **GitHub Actions variables and secrets** configured for the
  ...
  | Name | Kind | Purpose |
  |------|------|---------|
  | `CREW_RELEASE_TAGGER_CLIENT_ID` | Variable | GitHub App client ID used to create protected release tags |
  | `CREW_RELEASE_TAGGER_PRIVATE_KEY` | Secret | GitHub App private key |
  ...
  | `CREW_UPDATER_PUBLIC_KEY` or `SPROUT_UPDATER_PUBLIC_KEY` | Secret | Tauri updater public key |
