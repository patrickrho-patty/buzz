...
Next to it, a "Connect on Crew" button.
...
You hit "Connect on Crew" and the app opens. You're in `#general`. The team is
...
"Connect on Crew" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Crew as a collaboration
layer on top of GitHub if that's what makes sense — work in Crew channels, push
...
Someone picks up the bug. They create a branch. Crew creates a channel:
...
things are announcements. Some things are essays. Crew has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Crew"
