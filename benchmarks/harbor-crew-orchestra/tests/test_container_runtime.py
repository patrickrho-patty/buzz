...
from harbor_crew_orchestra.container_runtime import (
    REMOTE_BIN,
    REMOTE_EVIDENCE,
    REMOTE_LOGS,
    THINKING_EFFORT,
...
from harbor_crew_orchestra.manifest import ExperimentManifest
from harbor_crew_orchestra.provisioning import (
    AgentCredential,
    FixtureActor,
    TrialHandle,
)
from harbor_crew_orchestra.task_fixtures import fixture_for
...
async def test_forwarder_bridges_the_canonical_relay_address(tmp_path):
    from harbor_crew_orchestra.container_runtime import FORWARDER
...
async def test_wait_for_agents_ready_requires_every_channel_subscription(tmp_path):
    ...
    from harbor_crew_orchestra.container_runtime import _Agent
