...
Run inside the testbed environment (the just recipe does this):
    ...
    uv run --project benchmarks/harbor-crew-orchestra/testbed \
        benchmarks/harbor-crew-orchestra/scripts/benchmark.py [--gui] [...]
"""
...
def load_state() -> dict[str, str]:
    ...
    from harbor_crew_testbed.keys import generate_keypair, keypair_from_secret
...
def print_user_identity(state: dict[str, str]) -> None:
    ...
    nothing beyond it)."""
    from harbor_crew_testbed.keys import encode_nsec
