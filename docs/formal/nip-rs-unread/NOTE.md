...
tags: [nostr, nip-rs, read-state, formal-model, crew]
status: active
created: 2026-07-16
---
...
(below): every context ID Crew actually generates (channel UUID,
...
**Cost:** zero bytes for every context ID Crew generates today (channel
...
">256-byte key drop hazard" section: Crew's own key shapes cannot
