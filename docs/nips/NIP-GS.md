...
2. `CREW_PRIVATE_KEY` environment variable.
...
1. `CREW_AUTH_TAG` environment variable — a JSON-encoded array of 4 strings
...
(`NOSTR_PRIVATE_KEY`, `CREW_PRIVATE_KEY`). Environment variables are visible
to:
