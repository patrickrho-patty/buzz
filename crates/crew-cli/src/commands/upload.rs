...
pub async fn dispatch(cmd: crate::UploadCmd, client: &CrewClient) -> Result<(), CliError> {
    match cmd {
...
pub async fn dispatch_media(cmd: crate::MediaCmd, client: &CrewClient) -> Result<(), CliError> {
    match cmd {
