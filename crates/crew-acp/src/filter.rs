...
///   `str_ends_with`, `str_len` (duplicated intentionally from crew-workflow).
...
/// `str_len` — duplicated from crew-workflow intentionally so this crate
/// has no runtime dependency on crew-workflow.
