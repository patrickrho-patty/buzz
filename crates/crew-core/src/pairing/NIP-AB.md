...
```bash
tamarin-prover --prove crates/crew-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `crew-pair test-vectors`.
