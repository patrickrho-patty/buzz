    ...
    serde_json::json!({
        ...
        "properties": {
            ...
            "image": {
                "type": "string",
                "title": "Agent image",
                "description": "Digest-pinned image containing the crew-acp runtime ABI, e.g. ghcr.io/block/buzz-sprig@sha256:<digest>. Tags alone are not accepted: this pod holds the agent's private key.",
