...
pub const DEFAULT_IMAGE: &str = "ghcr.io/block/crew-sprig:sha-6530b58@sha256:17facfc7608d8ddb33bc056c9aaba1098f4ef6abe5655702fbfd7584d1f74d76";
    ...
    serde_json::json!({
        ...
        "properties": {
            ...
            "image": {
                "type": "string",
                "title": "Agent image",
                "description": "Digest-pinned image containing the crew-acp runtime ABI, e.g. ghcr.io/block/crew-sprig@sha256:<digest>. Tags alone are not accepted: this pod holds the agent's private key.",
...
mod tests {
    ...
    fn digest_ref() -> String {
        format!("ghcr.io/block/crew-sprig@sha256:{}", "a".repeat(64))
    }
    ...
    fn image_is_required_and_must_be_digest_pinned() {
        ...
        cfg["image"] = "ghcr.io/block/crew-sprig:latest".into();
    ...
    fn schema_default_image_round_trips_through_parse() {
        ...
        assert_eq!(
            parsed.image.as_str(),
            "ghcr.io/block/crew-sprig@sha256:17facfc7608d8ddb33bc056c9aaba1098f4ef6abe5655702fbfd7584d1f74d76"
        );
    }
