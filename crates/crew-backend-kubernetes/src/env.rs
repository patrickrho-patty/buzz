...
/// `RespondTo` (kebab-case) and as `crew-acp`'s CLI parses it.
const RESPOND_TO_ALLOWLIST: &str = "allowlist";

/// Every gate mode `crew-acp` accepts, spelled as its `clap::ValueEnum` parses
...
///
/// Mirrors `crew-acp`'s own rules exactly (`config.rs:95-101,996-1004,629-641`),
