#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Crew private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `crew-conformance`
/// checker.
pub mod conformance;
...
/// Workflow action sink — relay-side implementation of [`crew_workflow::ActionSink`].
