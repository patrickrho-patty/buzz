...
///
/// The wire cap is 16 MiB (`crew_relay_mesh::wire::MAX_STREAM_FRAME`), but using
...
mod tests {
    ...
    use crew_relay_mesh::{InboundHandler, MeshDatagram, PeerInfo};
    ...
    struct DirectTransport {
        peer: crew_relay_mesh::peer::MeshPeer,
    ...
    fn payload_chunking_covers_goose_sized_bodies() {
        ...
        assert_eq!(chunks, 50);
        assert!(MAX_RELIABLE_PAYLOAD_BYTES < crew_relay_mesh::wire::MAX_STREAM_FRAME as usize);
    }
