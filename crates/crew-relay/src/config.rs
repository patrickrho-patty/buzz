...
pub struct Config {
    ...
    ///
    /// The `crew-db` default of 20 was sized for a handful of pods against
    ...
    pub media: crew_media::MediaConfig,
...
fn rate_limit_config_from_env() -> Result<crew_auth::RateLimitConfig, ConfigError> {
...
const DEFAULT_PUSH_GATEWAY_DELIVERY_URL: &str = "https://push.patty.io/v1/deliveries/apns";
...
impl Config {
    ...
    pub fn from_env() -> Result<Self, ConfigError> {
        ...
        let mesh = crew_relay_mesh::MeshConfig {
