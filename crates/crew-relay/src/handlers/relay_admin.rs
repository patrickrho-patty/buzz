...
use crew_db::relay_members::RemoveResult;
...
fn admits_relay_admin_command(
    restriction: &crew_db::moderation::RestrictionState,
...
mod tests {
    ...
    fn banned_actor_is_not_admitted_to_a_relay_admin_command() {
        let banned = crew_db::moderation::RestrictionState {
            banned: true,
            muted_until: None,
        };
        assert_eq!(
    ...
    fn timed_out_actor_is_still_admitted() {
        let timed_out = crew_db::moderation::RestrictionState {
            banned: false,
    ...
    fn unrestricted_actor_is_admitted() {
        assert!(
            admits_relay_admin_command(&crew_db::moderation::RestrictionState::default()).is_ok()
        );
    }
