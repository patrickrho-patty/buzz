...
//! `key = sha256(relay_secret_key_bytes || "crew-invite-v1")`. Rotating the
...
pub use crew_core::invite::DEFAULT_INVITE_TTL_SECS;

/// Maximum invite lifetime a mint request may ask for: 30 days.
pub use crew_core::invite::MAX_INVITE_TTL_SECS;
...
const KEY_DERIVATION_LABEL: &[u8] = b"crew-invite-v1";
