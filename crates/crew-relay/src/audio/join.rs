...
/// [`MeshStreamFrame::Data`](crew_relay_mesh::MeshStreamFrame)`.payload`,
...
mod tests {
    ...
    use crew_relay_mesh::{BoxFuture, StreamRecvHalf, StreamSendHalf};
    ...
    impl RelayPeerTransport for NullTransport {
        ...
        fn set_inbound(&self, _handler: Box<dyn crew_relay_mesh::InboundHandler>) {}
    }
