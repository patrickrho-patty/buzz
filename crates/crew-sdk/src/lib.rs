...
/// Re-export kind constants so consumers don't need crew-core directly.
pub use crew_core::kind;
...
pub use crew_core::channel::canonical_channel_name;
/// Channel type.
pub use crew_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use crew_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use crew_core::channel::MemberRole;
