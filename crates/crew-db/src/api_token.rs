...
mod tests {
    ...
    async fn lookup_by_hash_is_scoped_to_community() {
        ...
        let cid_a = crew_core::CommunityId::from_uuid(community_a);
        let cid_b = crew_core::CommunityId::from_uuid(community_b);
        ...
        let cid_c = crew_core::CommunityId::from_uuid(community_c);
        let from_c = db
