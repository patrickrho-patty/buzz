...
mod tests {
    ...
    fn needs_action_query_includes_approval_and_reminder_kinds() {
        use crew_core::kind::{KIND_STREAM_REMINDER, KIND_WORKFLOW_APPROVAL_REQUESTED};
    ...
    fn activity_query_excludes_workflow_execution_kinds() {
        ...
        use crew_core::kind::{KIND_WORKFLOW_APPROVAL_DENIED, KIND_WORKFLOW_TRIGGERED};
    ...
    fn mentions_query_is_tenant_scoped_and_joins_mentions_by_composite_key() {
        ...
        assert!(
            ...
            "mentions feed must include Crew Git roots and comments: {sql}"
        );
    }
