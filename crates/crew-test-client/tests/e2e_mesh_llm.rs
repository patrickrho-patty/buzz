...
//! | 5 | dropped member → typed auth failure reaches lastError | runbook (desktop harness) | crew-agent `-32001` unit |
...
/// B running a mesh client + a launched crew-agent pointed at B's local
