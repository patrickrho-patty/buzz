...
abstract final class EventKind {
  ...
  static const channelEventKinds = [
    deletion, // 5
    reaction, // 7
    nip29DeleteEvent, // 9005 — Crew-native deletion
...
class NostrFilter {
  ...
  /// Crew relay bridge filter extensions (for example NIP-CW `top_level`).
...
/// Parse a Crew command response from the relay's OK message content.
///
