...
const _clientIdKeyPrefix = 'crew.nip-rs.client-id';
const _slotIdKeyPrefix = 'crew.nip-rs.slot-id';
const _uuid = Uuid();

String localReadStateKey(String pubkey) => 'crew.channel-read-state.v2:$pubkey';

String localPublishableContextKey(String pubkey) =>
    'crew.channel-read-state.publishable.v1:$pubkey';

String localSourceCreatedAtKey(String pubkey) =>
    'crew.channel-read-state.source-created-at.v1:$pubkey';
