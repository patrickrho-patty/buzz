...
/// Name of the first-party Crew theme. Crew reuses the GitHub Light palette for
...
/// gradient fills the sidebar canvas — see `data-crew-sidebar` in
...
///
/// Every theme uses its own [ColorScheme.onSurface]. Crew is the exception:
...
///
/// Section labels need more hierarchy than a placeholder. Crew therefore uses
...
/// Crew renders with its fixed neutral foreground while preserving the stored
...
/// Gradient stops, matching desktop's `--crew-gradient-*` custom properties.
...
/// The Crew gradient for the app's top section, or null when [themeName] is not
/// a Crew theme — in which case the section keeps its default frosted fill.
///
/// The stops are fully opaque: under Crew the color replaces the frosted
