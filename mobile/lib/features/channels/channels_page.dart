...
import '../../shared/widgets/crew_titled_sheet_layout.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FrostedScaffold(
      ...
      appBar: FrostedAppBar(
        ...
        // Let the full Crew gradient show at rest. Once the list begins to
        // move beneath this row, build up blur over the first 64dp of scroll
        // without adding the usual white frosted wash. The Crew list is
