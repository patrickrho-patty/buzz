...
String channelSortKey(String pubkey, String relayUrl) =>
    'crew.channel-sort.v1:$pubkey:${Uri.encodeComponent(normalizeChannelSortRelayUrl(relayUrl))}';

String legacyChannelSortKey(String pubkey) => 'crew.channel-sort.v1:$pubkey';
