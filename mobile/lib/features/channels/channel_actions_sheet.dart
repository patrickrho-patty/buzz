...
import '../../shared/widgets/crew_action_tile.dart';
            ...
            children: [
              ...
              if (!channel.isDm)
                ListTile(
                  ...
                  onTap: () async {
                    final shouldClose = await showCrewModalBottomSheet<bool>(
                      context: context,
...
Future<void> _confirmAndRun(
  ...
  final confirmed = await showCrewDialog<bool>(
    context: pageContext,
...
Future<void> _showMoveSectionSheet(
  ...
  await showCrewModalBottomSheet<void>(
    context: context,
    showDragHandle: true,
...
Future<String?> _showSectionNameDialog(BuildContext context) async {
  ...
  final result = await showCrewDialog<String>(
    context: context,
    builder: (dialogContext) => AlertDialog(
      title: const Text('New Section'),
