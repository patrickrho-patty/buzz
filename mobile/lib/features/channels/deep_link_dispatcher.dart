...
/// Routes pending `crew://message` deep links into the channel view.
///
...
typedef DeepLinkDestinationBuilder =
    Widget Function(Channel channel, CrewDeepLink link);
...
class _DeepLinkDispatcherState extends ConsumerState<DeepLinkDispatcher> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<CrewDeepLink?>(pendingDeepLinkProvider, (_, link) {
      _maybeDispatch(link);
    });
  ...
  void _maybeDispatch(CrewDeepLink? link) {
