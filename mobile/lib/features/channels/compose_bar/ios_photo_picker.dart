...
const _inlinePhotoPickerViewType = 'crew/inline_photo_picker';
const _inlinePhotoPickerSupportChannel = MethodChannel(
  'crew/inline_photo_picker',
);
          ...
          UiKitView(
            ...
            onPlatformViewCreated: (viewId) {
              pickerChannel.value = MethodChannel(
                'crew/inline_photo_picker/$viewId',
              );
            },
          ),
...
class _NativePhotoPickerLoading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      width: double.infinity,
      child: const Center(
        child: CrewLoadingIndicator(size: 44, semanticLabel: 'Opening Photos'),
      ),
    );
  }
}
