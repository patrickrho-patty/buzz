  ...
  Widget build(BuildContext context) {
    final verificationContent = Column(
      ...
      children: [
        ...
        Text(
          sendsIdentityToDesktop
              ? 'Make sure the six-digit code matches on both devices. Your full Crew identity will transfer to the desktop and grant it permanent access. Only continue if you started this recovery.'
