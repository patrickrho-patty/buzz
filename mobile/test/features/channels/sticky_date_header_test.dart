...
import 'package:crew/features/channels/sticky_date_header.dart';
...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      const channel = MethodChannel('crew/sticky_date_glass/42');
      ...
      try {
        ...
        expect(nativeView.viewType, 'crew/sticky_date_glass');
