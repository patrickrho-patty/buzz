...
import 'package:crew/features/channels/jump_to_latest_button.dart';
import 'package:crew/features/channels/jump_to_latest_switcher.dart';
...
void main() {
  testWidgets('uses native iOS liquid glass outside message-action backdrops', (
    ...
    const channel = MethodChannel('crew/jump_to_latest_glass/41');
    ...
    try {
      ...
      expect(nativeView.viewType, 'crew/jump_to_latest_glass');
