...
[[ "$repo" == "block/crew" ]] || fail "candidate publishing is restricted to block/crew"
...
message="Crew Mobile $version release candidate $candidate_number"
tag_object_sha="$(
...
printf 'Published %s at %s through crew-release-bot.\n' "$tag" "$target_sha"
