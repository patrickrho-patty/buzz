...
# Installed Crew state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Crew app state and its production keyring are preserved."
...
success "Desktop development state removed (installed Crew state preserved)"
