...
// (compile-time rejection of baked `CREW_BUILD_AGENT_ENV` collisions) and
...
/// implications. Behavior knobs (GOOSE_MODE, CREW_ACP_MODEL, CREW_ACP_SYSTEM_PROMPT, …) remain freely
...
pub(crate) const RESERVED_ENV_KEYS: &[&str] = &[
    ...
    // launch.policy_env. A user-supplied CREW_ACP_AGENTS would bypass the
    ...
    "CREW_MANAGED_AGENT",
    "CREW_MANAGED_AGENT_START_NONCE",
];
