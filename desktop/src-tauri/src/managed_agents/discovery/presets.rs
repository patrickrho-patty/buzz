...
pub(super) const PRESET_HARNESSES: &[PresetHarness] = &[
    PresetHarness {
        ...
        install_hint: "Crew talks to Devin through the official Devin CLI's ACP mode (devin acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "cursor",
        ...
        install_hint: "Crew talks to Cursor through the cursor-agent CLI's ACP mode.",
        underlying_cli: None,
    },
    PresetHarness {
        id: "omp",
        ...
        install_hint: "Crew talks to Oh My Pi through its CLI's ACP mode (omp acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "grok",
        ...
        install_hint: "Crew talks to Grok Build through its CLI's agent stdio mode.",
        underlying_cli: None,
    },
    PresetHarness {
        id: "opencode",
        ...
        install_hint: "Crew talks to OpenCode through its CLI's ACP mode (opencode acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "kimi",
        ...
        install_hint: "Crew talks to Kimi Code through its CLI's ACP mode (kimi acp).",
        underlying_cli: None,
    },
    PresetHarness {
        id: "amp",
        ...
        install_hint: "Crew talks to the Amp CLI through the amp-acp adapter. Follow the setup guide to install the adapter so the amp-acp command is on your PATH.",
    ...
    PresetHarness {
        ...
        install_hint: "Crew talks to Hermes Agent through its hermes-acp command.",
        underlying_cli: None,
    },
    PresetHarness {
        id: "openclaw",
