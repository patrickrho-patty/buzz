...
use crew_core_pkg::kind::KIND_PAIRING;
use crew_core_pkg::pairing::qr::encode_qr;
use crew_core_pkg::pairing::session::PairingSession;
use crew_core_pkg::pairing::types::{AbortReason, PayloadType};
...
/// Parse a relay EVENT message into a nostr 0.36 Event (crew-core compatible).
