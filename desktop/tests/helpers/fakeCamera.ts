  ...
  return page.addInitScript(
    (cameraOptions) => {
      ...
      const testWindow = window as Window & {
        __CREW_E2E_CAMERA_CONSTRAINTS__?: MediaStreamConstraints[];
        __CREW_E2E_CAMERA_REQUEST_COUNT__?: number;
        __CREW_E2E_RELEASE_CAMERA__?: () => void;
      };
      testWindow.__CREW_E2E_CAMERA_CONSTRAINTS__ = [];
      testWindow.__CREW_E2E_CAMERA_REQUEST_COUNT__ = 0;
      let releaseCamera: (() => void) | null = null;
      testWindow.__CREW_E2E_RELEASE_CAMERA__ = () => {
        releaseCamera?.();
        releaseCamera = null;
      };
      ...
      Object.defineProperty(mediaDevices, "getUserMedia", {
        ...
        value: async (constraints: MediaStreamConstraints) => {
          testWindow.__CREW_E2E_CAMERA_CONSTRAINTS__?.push(constraints);
          testWindow.__CREW_E2E_CAMERA_REQUEST_COUNT__ =
            (testWindow.__CREW_E2E_CAMERA_REQUEST_COUNT__ ?? 0) + 1;
          if (
            testWindow.__CREW_E2E_CAMERA_REQUEST_COUNT__ <=
