...
const relayBaseUrl = process.env.CREW_E2E_RELAY_URL ?? "http://localhost:3000";
const seedTimeoutMs = Number.parseInt(
  process.env.CREW_E2E_SEED_TIMEOUT_MS ?? (isCi ? "60000" : "25000"),
  10,
);
const requestTimeoutMs = Number.parseInt(
  process.env.CREW_E2E_SEED_REQUEST_TIMEOUT_MS ?? (isCi ? "5000" : "2000"),
  10,
);
const retryDelayMs = Number.parseInt(
  process.env.CREW_E2E_SEED_RETRY_DELAY_MS ?? "1000",
  10,
);
