...
// (crew-relay/src/handlers/ingest.rs). Eva's channel-window surface reads that
...
//
// Transport auth: the test relay runs CREW_REQUIRE_AUTH_TOKEN=false
...
//
// Canonical tag shapes (crates/crew-sdk/src/builders.rs thread_tags + ingest):
