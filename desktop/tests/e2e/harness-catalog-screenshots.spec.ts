...
const CATALOG = [
  ...
  },
  {
    ...
    mcp_command: null,
    install_hint:
      "Crew talks to Cursor through the cursor-agent CLI's ACP mode.",
  ...
  },
  {
    ...
    mcp_command: null,
    install_hint:
      "Crew talks to Oh My Pi through its CLI's ACP mode (omp acp).",
  ...
  },
  {
    ...
    mcp_command: null,
    install_hint:
      "Crew talks to OpenCode through its CLI's ACP mode (opencode acp).",
