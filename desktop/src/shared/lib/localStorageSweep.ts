...
export const LOCAL_STORAGE_SWEEP_RULES: readonly LocalStorageSweepRule[] = [
  { keyPrefix: "crew-channel-messages.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "crew-channels.v1:", maxAgeMs: 14 * DAY_MS },
  ...
  { keyPrefix: "crew-user-labels.v1:", maxAgeMs: 14 * DAY_MS },
  // Do not add crew-self-profile.v1: here. It is the load-bearing offline
