...
export const chromeCssVars = {
  topChromeHeight: "--crew-top-chrome-height",
  channelContentTopPadding: "--crew-channel-content-top-padding",
} as const;
...
export const topChromeBackdrop = {
  ...
  height: "h-(--crew-top-chrome-height,40px)",
  /** `after:` pseudo-element offset aligned to the bottom of top chrome. */
  dividerTop: "after:top-(--crew-top-chrome-height,40px)",
} as const;
...
export const channelChrome = {
  ...
  contentPadding: "pt-(--crew-channel-content-top-padding,5.75rem)",
  /** Absolute/fixed top offset below the measured channel header chrome. */
  top: "top-(--crew-channel-content-top-padding,5.75rem)",
  /** Sticky timeline controls sit slightly below the channel navigation. */
  stickyTimelineTop:
    "top-[calc(var(--crew-channel-content-top-padding,5.75rem)+0.5rem)]",
  /** Height matching the measured channel header chrome. */
  headerHeight: "h-(--crew-channel-content-top-padding,5.75rem)",
  /** Negative margin for overlaid channel chrome that should not affect flow. */
  negativeMargin: "-mb-(--crew-channel-content-top-padding,5.75rem)",
} as const;
