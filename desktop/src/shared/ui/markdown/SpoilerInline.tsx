...
export function SpoilerInline({
  ...
  if (!interactive) {
    if (isBlock) {
      return (
        <div
          className="crew-spoiler crew-spoiler--block crew-spoiler--inert"
          data-revealed="false"
          data-spoiler=""
        >
          <SpoilerParticles active contentRef={contentRef} />
          <div className="crew-spoiler__content" ref={setContentElement}>
    ...
    return (
      <span
        className="crew-spoiler crew-spoiler--inert"
        data-revealed="false"
        data-spoiler=""
      >
        <SpoilerParticles active contentRef={contentRef} />
        <span className="crew-spoiler__content" ref={setContentElement}>
          <SpoilerHiddenContext.Provider value={true}>
            {children}
          </SpoilerHiddenContext.Provider>
        </span>
  ...
  if (isBlock) {
    return (
      <div
        {...revealProps}
        className="crew-spoiler crew-spoiler--block"
