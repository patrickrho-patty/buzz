      ...
      >
        <DialogPrimitive.Content
          className={cn(
            ...
            surface === "textured" &&
              "crew-card-textured isolate box-border w-full rounded-none border-0 bg-transparent p-[var(--crew-card-textured-safe-inset)] shadow-none",
            MODAL_CONTENT_MOTION_CLASS,
            className,
          )}
          ref={ref}
          ...
          {showCloseButton ? (
            <DialogPrimitive.Close
              className={cn(
                ...
                surface === "textured"
                  ? "right-[var(--crew-card-textured-safe-inset)] top-[var(--crew-card-textured-safe-inset)] -mr-2 -mt-2"
                  : "right-4 top-4",
                closeButtonClassName,
              )}
            >
