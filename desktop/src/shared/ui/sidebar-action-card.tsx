...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="crew-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="crew-sidebar-action-description">
      ...
      <span aria-hidden className="crew-sidebar-action-description__motion">
        <span
          className="crew-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "crew-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isSuccess
              ? "crew-sidebar-action-card__success-icon"
