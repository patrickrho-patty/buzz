...
const TIMECODE_ACCENT_CLASS =
  "bg-[hsl(var(--crew-video-review-accent,var(--primary))/0.15)] text-[hsl(var(--crew-video-review-accent-foreground,var(--crew-video-review-accent,var(--primary))))]";
const TIMECODE_ACCENT_HOVER_CLASS =
  "hover:bg-[hsl(var(--crew-video-review-accent,var(--primary))/0.3)]";
