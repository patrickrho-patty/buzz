...
export const TEXTURED_SURFACE_CLASS =
  "crew-card-textured relative isolate rounded-none border-0 bg-transparent p-[var(--crew-card-textured-safe-inset)] shadow-none";
...
export function texturedSurfaceClasses({
  ...
  return cn(
    ...
    tone === "dark" && "crew-card-textured-dark",
    size === "compact" && "crew-card-textured-compact",
  );
}
 ...
 * - Default padding is the safe inset (`--crew-card-textured-safe-inset`),
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === "textured" &&
            textureTone === "dark" &&
            "crew-card-textured-dark",
          variant === "textured" &&
            textureSize === "compact" &&
            "crew-card-textured-compact",
        )}
        {...props}
      />
    );
