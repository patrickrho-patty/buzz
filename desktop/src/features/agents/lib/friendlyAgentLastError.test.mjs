...
test("crew-acp wrapped auth failure → denied copy", () => {
...
test("unwrapped crew-agent prefix → denied copy", () => {
  // crew-agent's AgentError::LlmAuth Display is "llm auth: <body>"; if the
...
test("code -32001 → Crew shared compute denied copy (structured path)", () => {
