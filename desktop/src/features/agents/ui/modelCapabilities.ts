 ...
 * mirroring the Rust interpreter in `crates/crew-agent/src/model_capabilities.rs`
...
/** Valid thinking-effort values accepted by crew-agent (mirrors parse_thinking_effort in config.rs). */
