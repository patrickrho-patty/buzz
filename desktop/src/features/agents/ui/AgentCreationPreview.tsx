      ...
      >
        ...
        {activeTab === "emoji" ? (
          <div className="relative grid content-start gap-3">
            <div
              className="crew-emoji-mart relative z-0 h-[280px] overflow-hidden rounded-lg bg-muted"
                    ...
                    >
                      <span
                        className={cn(
                          "flex h-full w-full items-center justify-center leading-none",
                          isCompact ? "text-2xl" : "text-[4rem]",
                          squishKey > 0 && "crew-avatar-squish",
                        )}
                        key={squishKey}
                        style={
                          {
                            "--crew-avatar-emoji-offset-x": "0px",
                            "--crew-avatar-emoji-offset-y": "0px",
