...
const SIDEBAR_PROJECTS_FILTER_KEY = "crew.sidebar.projects.filter";
const SIDEBAR_PROJECTS_SORT_KEY = "crew.sidebar.projects.sort";
const SIDEBAR_PROJECTS_EXPANDED_KEY = "crew.sidebar.projects.expanded";
