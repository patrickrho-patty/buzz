...
const CLIPBOARD_ATTRIBUTE = "data-crew-agent-snapshot";
...
/** Build Crew-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a Crew snapshot clipboard payload into one pending attachment. */
