...
const SPOILER_SELECTOR = ".crew-spoiler[data-spoiler]";
...
function mountComposerSpoilerParticles(
  ...
  overlayRoot.className = "crew-spoiler-composer-particles";
  ...
  const mountSpoiler = (spoiler: HTMLElement) => {
    ...
    canvas.className =
      "crew-spoiler__particles crew-spoiler__particles--composer";
