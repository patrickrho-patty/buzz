...
export function HostedCommunityCreateFlow({
      ...
      if (bound.error) {
        ...
        throw new Error(
          bound.error.code === "pubkey_already_bound"
            ? "This device's Crew identity belongs to a different Builderlab account. Sign in with the account that already owns this identity."
            : hostedCommunityErrorMessage(
                bound.error,
    ...
    return (
      <div className="space-y-5">
        <p className="text-sm leading-6 text-muted-foreground">
          Sign in with Builderlab to create and host a community. Crew will open
  ...
  if (!identity) {
    return (
      <div className="space-y-5">
        <p className="text-sm leading-6 text-muted-foreground">
          Connect this device’s Crew identity to your Builderlab account. Your
  ...
  if (identityMismatch) {
    return (
      <div className="space-y-5">
        <p className="text-sm leading-6 text-muted-foreground">
          This Builderlab account uses a different Crew identity. Switch it to
