...
export const HOSTED_COMMUNITY_SUFFIX = "communities.crew.xyz";
...
export function hostedCommunityErrorMessage(
  ...
  const messages: Record<string, string> = {
    missing_mapping: "Connect your Crew identity before creating a community.",
    invalid_name: "Use lowercase letters, numbers, and hyphens.",
    taken: "That Crew address is already taken.",
    ...
    identity_already_bound:
      "This Builderlab account is connected to another Crew identity.",
    pubkey_already_bound:
      "This Crew identity is connected to another Builderlab account.",
    not_owner: "Only the community owner can do that.",
    transferee_not_registered:
      "That person needs a connected Crew identity before you can transfer ownership to them.",
  };
