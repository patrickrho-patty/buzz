    ...
    <AlertDialog onOpenChange={onOpenChange} open={open}>
      <AlertDialogContent data-testid="agent-delete-confirm-dialog">
        ...
        <ul className="list-disc space-y-1.5 pl-5 text-sm text-muted-foreground">
          ...
          <li>
            {isProviderAgent
              ? "Requests remote deletion; if it is online, Crew first sends a shutdown command when possible. If the deployment cannot be reached through a channel, the remote process may keep running without local management."
