              ...
              {showAnyProfileActions ? (
                <div className="flex gap-2">
                  {showHumanProfileActions ? (
                    <Button
                      aria-label="Wave"
                      className="crew-wave-hover-trigger shrink-0 px-3 transition-transform duration-100 ease-out motion-reduce:transition-none motion-safe:active:scale-[0.97]"
                    ...
                    >
                      {pendingAction === "wave" ? (
                        ...
                        <span
                          aria-hidden="true"
                          className="crew-wave-hand text-sm leading-none"
                        >
                          👋
                        </span>
                      )}
