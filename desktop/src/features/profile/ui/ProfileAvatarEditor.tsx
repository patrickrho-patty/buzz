...
export function ProfileAvatarEditor({
    ...
    () =>
      ({
        ...
        ...(presentation === "onboarding-modal"
          ? {
              "--crew-emoji-picker-category-icon-size": "18px",
              "--crew-emoji-picker-fade-height": "56px",
              "--crew-emoji-picker-fade-opacity": "1",
              "--crew-emoji-picker-nav-button-size": "32px",
              "--crew-emoji-picker-nav-padding-x": "12px",
              "--crew-emoji-picker-padding": "10px",
              "--crew-emoji-picker-scroll-padding-top": "18px",
            }
          : null),
  ...
  React.useEffect(() => {
    ...
    const syncSelectedEmojiButton = () => {
      ...
      shadowRoot
        .querySelectorAll('button[data-crew-selected="true"]')
        .forEach((button) => {
          button.removeAttribute("data-crew-selected");
        });
      if (selectedEmoji) {
        shadowRoot.querySelectorAll(".category button").forEach((button) => {
          if (button.getAttribute("aria-label") === selectedEmoji) {
            button.setAttribute("data-crew-selected", "true");
          }
        });
      }
              ...
              {mode === "image" ? (
                <div className="grid content-start gap-3">
                  <button
                    className={cn(
                      isOnboardingModal
                        ? "relative flex h-32 flex-col items-center justify-center overflow-hidden rounded-lg border border-dashed border-[color:rgb(var(--crew-onboarding-avatar-control-fg)_/_0.7)] bg-transparent text-[rgb(var(--crew-onboarding-avatar-control-fg))] transition-[background-color,border-color,box-shadow,color] duration-[250ms] ease-out hover:bg-[color:rgb(var(--crew-onboarding-avatar-accent-bg)_/_0.18)] disabled:opacity-60"
                      ...
                      isImageDropActive &&
                        (isOnboardingModal
                          ? "border-[rgb(var(--crew-onboarding-avatar-control-fg))] bg-[color:rgb(var(--crew-onboarding-avatar-accent-bg)_/_0.24)]"
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        isOnboardingModal
                          ? "text-sm font-normal text-[rgb(var(--crew-onboarding-avatar-control-fg))]"
                          : "text-sm font-medium text-muted-foreground",
                        isImageDropActive &&
                          (isOnboardingModal
                            ? "text-[rgb(var(--crew-onboarding-avatar-control-fg))]"
                            : "text-primary"),
                      )}
                    >
                      {isUploading ? (
                  ...
                  <div
                    className={cn(
                      ...
                      isOnboardingModal
                        ? "h-[52px] rounded-lg border border-[color:rgb(var(--crew-onboarding-avatar-control-fg)_/_0.45)] bg-transparent px-5 focus-within:border-[rgb(var(--crew-onboarding-avatar-control-fg))]"
                  ...
                  >
                    ...
                    <input
                      ...
                      className={cn(
                        ...
                        isOnboardingModal
                          ? "text-center text-sm font-normal text-foreground placeholder:text-[color:rgb(var(--crew-onboarding-avatar-control-fg)_/_0.55)]"
                ...
                <div className="relative grid content-start gap-3">
                  <div
                    className={cn(
                      "crew-emoji-mart relative z-0 overflow-hidden rounded-xl bg-muted transition-colors duration-[250ms] ease-out",
          ...
          <AnimatePresence initial={false}>
            {shouldShowDoneButton ? (
              <Button
                ...
                className={cn(
                  isOnboardingModal
                    ? "mx-auto mt-0 h-[2.375rem] min-w-24 rounded-full bg-[rgb(var(--crew-onboarding-avatar-action-bg))] px-6 text-sm font-medium text-[rgb(var(--crew-onboarding-avatar-action-fg))] hover:bg-[color:rgb(var(--crew-onboarding-avatar-action-bg)_/_0.9)]"
