...
export function AvatarFramingSlider({
  ...
  const sliderControl = (
    <div className="crew-avatar-framing-slider-wrapper">
      <div
        ...
        className={cn(
          "crew-avatar-framing-slider",
          compact && "crew-avatar-framing-slider--compact",
        )}
        ...
        style={
          {
            "--crew-avatar-framing-slider-fill": `${fill}%`,
          } as React.CSSProperties
        }
        tabIndex={disabled ? -1 : 0}
      >
        <div className="crew-avatar-framing-slider-hashmarks">
          {ticks.map((tick) => (
            <span
              aria-hidden="true"
              className="crew-avatar-framing-slider-hashmark"
              key={tick}
              style={{
        ...
        <div aria-hidden="true" className="crew-avatar-framing-slider-fill" />
        <div aria-hidden="true" className="crew-avatar-framing-slider-handle" />
      </div>
      <button
      ...
      {tipText ? (
        <p
          className="crew-avatar-framing-slider-tip"
