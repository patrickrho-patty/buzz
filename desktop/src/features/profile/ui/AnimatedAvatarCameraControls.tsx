        ...
        {onRetry ? (
          <Button
            className={cn(
              ...
              compact &&
                "bg-[rgb(var(--crew-onboarding-avatar-accent-bg))] text-[rgb(var(--crew-onboarding-avatar-accent-fg))] hover:bg-[rgb(var(--crew-onboarding-avatar-accent-bg))]",
            )}
          ...
          <Button
            ...
            className={cn(
              compact
                ? "h-[2.375rem] rounded-full bg-[rgb(var(--crew-onboarding-avatar-action-bg))] px-6 text-sm font-medium text-[rgb(var(--crew-onboarding-avatar-action-fg))] hover:bg-[color:rgb(var(--crew-onboarding-avatar-action-bg)_/_0.9)]"
                : "h-12 w-full rounded-xl",
            )}
