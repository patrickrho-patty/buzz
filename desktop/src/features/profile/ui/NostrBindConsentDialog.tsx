...
const COPY_SUCCESS_MESSAGE =
  "Signed response copied. Paste it into the Crew admin console.";
const PREVIEW_COPY_SUCCESS_MESSAGE = "Preview response copied.";
const COPY_FAILURE_MESSAGE = "Crew couldn't access the clipboard. Try again.";
    ...
    const unlistenPromise = listenForNostrBindDeepLinks((nextPayload) => {
      ...
      getIdentity()
        ...
        .catch((error) => {
          ...
          setIdentity(null);
          setError("Could not load the current Crew identity.");
        });
    });
            ...
            <div className="m-auto flex w-full max-w-[500px] flex-col items-center text-center">
              ...
              {signedResponse ? (
                ...
                >
                  ...
                  >
                    {payload.returnMode === "browser_fragment_v1"
                      ? "Crew opened your browser to finish verification."
                      : "Copy the response below, then paste it into the Crew website to finish verification."}
                  </DialogPrimitive.Description>
