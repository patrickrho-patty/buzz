 ...
 * addressed by a `crew://` link — addressable d-tags accept a wider charset
 ...
 * have their own `crew://pr` links, so both map to `undefined` (no tab).
 */
 ...
 * announcement rather than a kind:30621 event, so they share as `crew://repo`
