...
> = {
  authentication: {
    description:
      "Crew could not authenticate with this repository. Check your access and try again.",
    title: "Repository access failed",
  },
  missing: {
    description:
      "The project announcement exists, but its git repository was not found on the Crew relay.",
  ...
  network: {
    description:
      "The Crew git service could not be reached. Check your connection and try again.",
  ...
  unknown: {
    description:
      "Crew could not load this repository. Try again or contact the project owner.",
 ...
 * `crew-channel` binding and the viewer's own channel memberships:
 *
