...
export const WELCOME_GUIDE_INTRO_MARKER = "crew-welcome-intro.v1";
...
export const WELCOME_GUIDE_INTRO_MESSAGE =
  "Hi, I'm Fizz. Welcome to Crew.\n\nI can help you get oriented, answer questions, and make the first few steps feel less mysterious.\n\nFeel free to ask me what else you can do in Crew, or just talk through what you want to build.";
