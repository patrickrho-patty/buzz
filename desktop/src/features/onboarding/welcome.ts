...
export const WELCOME_CHANNEL_READY_EVENT =
  "crew:onboarding-welcome-channel-ready";
export const WELCOME_SURFACE_READY_EVENT =
  "crew:onboarding-welcome-surface-ready";

const PENDING_WELCOME_CHANNEL_STORAGE_KEY =
  "crew:onboarding-welcome-channel.v1";
const WELCOME_INITIAL_UNREAD_SUPPRESSION_STORAGE_KEY =
  "crew:onboarding-welcome-initial-unread-suppression.v1";
const PENDING_WELCOME_CHANNEL_MAX_AGE_MS = 5 * 60 * 1000;
const WELCOME_CHANNEL_ENSURED_STORAGE_KEY = "crew-welcome-channel-ensured.v2";
