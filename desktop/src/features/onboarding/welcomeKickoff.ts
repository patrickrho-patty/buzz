...
export function buildWelcomeKickoffOpener(
  ...
  if (introTeammates.length === 0) {
    ...
    return `${greeting} Welcome to Crew. This is your private home base, and I'm here${teammatePhrase} to help you get oriented or work through something you're building.\n\n${WELCOME_KICKOFF_CTA}`;
  }

  return `${greeting} Welcome to Crew. This is your private home base, and we're here to help you get oriented or work through something you're building.\n\n${introNames}, introduce ${introTeammates.length === 1 ? "yourself" : "yourselves"} in a sentence or two — share what you're good at and when to bring you in. Don't start any work yet.`;
}
