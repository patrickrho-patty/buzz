          ...
          {hasVerifiedBackup
            ...
            : hasSelectedBackup
              ...
              : hasCreated
                ...
                : "Keep the downloaded file private — you need both it and your password to restore your identity. Save the backup password somewhere safe; Crew cannot reset it if lost."}
        </p>
      </motion.div>
