...
export function PendingInviteGate() {
  ...
  return (
    <div
      className="crew-onboarding-neutral-theme crew-startup-shell fixed inset-0 z-50 flex items-center justify-center bg-background px-4 py-8 text-foreground"
