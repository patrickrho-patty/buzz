    ...
    >
            ...
            >
              <div className="relative w-full">
                <Input
                  ...
                  className="h-[3.6875rem] rounded-none border-0 bg-transparent px-10 text-center font-mono !text-4xl text-[color:var(--crew-onboarding-backup-ink)] shadow-none placeholder:text-foreground/30 focus-visible:ring-0"
      ...
      {!isPasswordStage && mode === "backup" ? (
        <>
          ...
          {isDragging ? (
            <fieldset
              className="absolute inset-[var(--crew-card-textured-safe-inset)] z-10 flex items-center justify-center rounded-2xl border-2 border-dashed border-primary/60 bg-background/80 backdrop-blur-sm"
              data-dragging="true"
          ...
          {!isPasswordStage && previewNpub ? (
            variant === "spotlight" ? (
              ...
              >
                ...
                <p className="break-all font-mono text-[color:var(--crew-onboarding-backup-ink)]">
                  {previewNpub}
                </p>
              </div>
            ) : (
