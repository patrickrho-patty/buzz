    ...
    >
      <div className="w-full max-w-2xl">
        ...
        <p className="mt-5 text-sm leading-6 text-muted-foreground">
          Pick the name people and agents will see in Crew. You can change it
          anytime.
        </p>
      </div>
          ...
          {!hasDisplayNameDraft ? (
            ...
            >
              <span className="relative inline-flex select-none items-center gap-0 text-4xl font-semibold text-muted-foreground/35 sm:text-5xl">
                <span
                  aria-hidden="true"
                  className="crew-onboarding-name-placeholder-caret h-[0.9em] w-0.5 rounded-full bg-primary"
                />
                Enter your name
              </span>
            </div>
