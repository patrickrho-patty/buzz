            ...
            <label className="block w-full" htmlFor="invite-input">
              ...
              <span className={ONBOARDING_KEY_ROW_CLASS}>
                <input
                  ...
                  className={cn(
                    ONBOARDING_KEY_TEXT_CLASS,
                    "block border-0 bg-transparent p-0 text-center shadow-none outline-none placeholder:text-[var(--crew-onboarding-backup-ink)] placeholder:opacity-40 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
                  )}
