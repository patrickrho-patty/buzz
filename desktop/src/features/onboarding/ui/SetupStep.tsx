...
function RuntimeReadinessIndicator({
  ...
  return (
    <span
      aria-hidden="true"
      className="pointer-events-none absolute right-8 top-8 flex h-8 w-8 items-center justify-center rounded-full border border-[var(--crew-welcome-chartreuse)] bg-[var(--crew-welcome-chartreuse)]"
    ...
    return (
      <div className="flex flex-col items-center gap-1.5">
        <Button
          ...
          className="crew-onboarding-runtime-setup h-5 rounded-full bg-[var(--crew-welcome-chartreuse)]/30 px-2.5 font-mono !text-badge font-normal uppercase text-foreground hover:bg-[var(--crew-welcome-chartreuse)]/40"
    ...
    return (
      <>
        ...
        <p className="mt-1 text-xs leading-4 text-white">
          ...
          adapter. Older Crew releases using the legacy adapter contract may
    ...
    <section className="flex min-h-full w-full flex-col items-center">
      <div className="w-full max-w-[820px] text-center">
        ...
        <p className="mx-auto mt-3 max-w-[760px] text-sm leading-6 text-foreground/90">
          Crew checks for command-line harnesses on this machine. Install the
      ...
      <div className="flex w-full flex-1 flex-col items-center justify-center gap-8 py-10">
        ...
        <p className="mx-auto flex max-w-[440px] items-start justify-center gap-1.5 text-center text-xs leading-5 text-[var(--crew-onboarding-backup-ink)]">
