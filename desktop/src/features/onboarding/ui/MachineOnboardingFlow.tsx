...
export function MachineOnboardingFlow({
  ...
  const signInWithPatty = React.useCallback(async () => {
    ...
    try {
      ...
      console.info("[crew-sso] SSO login result", {
  ...
  return (
    <div
      className={`crew-onboarding-neutral-theme crew-startup-shell flex max-h-dvh items-start justify-center overflow-x-hidden overflow-y-auto px-4 text-foreground ${
        isSecuritySubview ? "crew-onboarding-security-theme" : ""
      } ${
        page === "identity"
          ? "crew-onboarding-welcome py-8"
          : "pb-28 pt-[106px]"
      }`}
      ...
      <OnboardingFooterProvider backAction={chromeBackAction}>
        <div
          className={`relative flex w-full max-w-[1040px] flex-col items-center text-center ${
            page === "identity" ? "my-auto" : "crew-onboarding-step-frame"
          }`}
        >
          {page === "identity" ? (
            <OnboardingSlideTransition
            ...
            >
              ...
              >
                ...
                <div className="mt-5 max-w-[440px] text-sm leading-6 text-foreground/80">
                  {keyImportStage === "backup-password" ? (
                    ...
                    <p>
                      Paste your private key to sign in to Crew. You can also
                      use a{" "}
                      <button
              ...
              <div className="crew-onboarding-key-import-position w-full">
                ...
                >
                  <div className="mx-auto w-full max-w-[35rem] pb-6 pt-10 text-center max-sm:pb-4 max-sm:pt-6">
                    ...
                    <DialogDescription className="mx-auto mt-4 max-w-[28rem] text-sm leading-6 text-foreground/80">
                      Choose the encrypted backup file you saved from Crew.
                    </DialogDescription>
                    <NostrKeyImportForm
                      footerMode="inline"
                      mode="backup"
              ...
              >
                <DialogContent
                  className="crew-onboarding-neutral-theme max-h-[calc(100dvh-2rem)] max-w-[47.5rem] -translate-y-5 overflow-y-auto"
                  closeButtonClassName={ONBOARDING_INK_ICON_CLASS}
                  data-system-color-scheme="light"
