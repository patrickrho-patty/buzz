...
const NOTIFICATION_SETTINGS_STORAGE_KEY = "crew-notification-settings.v2";
      ...
      if (nextPermission !== "granted") {
        ...
        setErrorMessage(
          nextPermission === "denied"
            ? "Desktop notifications are blocked for Crew. Enable them in system settings to turn alerts on."
