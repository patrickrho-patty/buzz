...
const splitChevronButtonClass =
  "crew-huddle-split-chevron group h-12 w-auto shrink-0 rounded-l-none px-2 py-4";
...
type MicMeterBarStyle = CSSProperties & {
  "--crew-huddle-meter-height": string;
};
...
function micMeterBarStyle(heightRem: number): MicMeterBarStyle {
  return { "--crew-huddle-meter-height": `${heightRem}rem` };
}
...
export function MicControls({
  ...
  const chevronButtonClass = compact
    ? "crew-huddle-split-chevron group h-8 w-5 shrink-0 rounded-l-none rounded-r-md border-l border-sidebar-border/80 px-0.5 py-0 text-sidebar-foreground/70 !shadow-none hover:bg-sidebar-foreground/5 hover:text-sidebar-foreground/70"
  ...
  return (
    <Popover>
            ...
            {showMicMeter && !compact ? (
              ...
              >
                <span className="flex h-5 w-5 items-center justify-between text-current group-data-[state=open]:hidden group-focus-visible:hidden group-hover:hidden">
                  <span
                    className="crew-huddle-mic-meter-bar bg-current"
      ...
      <PopoverContent
        side="top"
        className="crew-huddle-drawer crew-huddle-popover w-64 text-foreground"
      >
      ...
      <div className="relative flex items-center">
        ...
        >
          ...
          <PopoverContent
            ...
            className="crew-huddle-drawer crew-huddle-popover crew-huddle-headphones-hint w-64 p-3 text-foreground"
        ...
        <Button
          ...
          className={cn(
            splitIconButtonClass,
            ttsEnabled ? "crew-huddle-split-main" : mutedHuddleControlClass,
          )}
          onClick={onToggleTts}
          size="icon"
