 ...
 * relay-admin paths, but `crew-admin add-member` deliberately emits none
 * (`crates/crew-admin/src/main.rs:6-13`), and kind:8000 fan-out is pod-local
 ...
 * (a kind:13534 snapshot larger than `CREW_MAX_FRAME_BYTES` never arrives).
 */
