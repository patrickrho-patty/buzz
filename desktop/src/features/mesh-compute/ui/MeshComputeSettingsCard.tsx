...
const MODEL_DRAFT_STORAGE_KEY = "crew.mesh-compute.share.model.v1";
const MAX_VRAM_DRAFT_STORAGE_KEY = "crew.mesh-compute.share.max-vram-gb.v1";
  ...
  if (isConsuming) {
    return (
      <p className="text-sm text-muted-foreground">
        ...
        sharing to switch to the selected local model; Crew may briefly restart.
      </p>
    );
  }
  if (!status) {
