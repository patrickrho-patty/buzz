...
/**
 * Root-level render fence for the desktop app (block/crew#5078).
 *
    ...
    if (error) {
      return (
        <div className="flex h-screen w-screen flex-col items-center justify-center gap-3 bg-background px-6 text-foreground">
          <p className="text-base font-semibold">Crew failed to start</p>
          <p className="max-w-md text-center text-sm text-muted-foreground">
            Reload Crew to try again. If this keeps happening, check that Crew
