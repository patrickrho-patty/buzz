...
// Animated Crew mark for the loading gates. The static CrewMark renders in
...
// centered Crew bee flying over it — the same static mark as before, now with
// its wings flapping (ported from the Crew website's wing-flap). Replaces the
